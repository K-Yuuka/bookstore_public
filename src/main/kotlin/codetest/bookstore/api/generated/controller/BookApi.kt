...
interface BookApi {
    ...
    fun bookBookIdPut(
        ...
        @Parameter(description = "", required = true) @RequestBody bookNameRequest: BookNameRequest
    ): ResponseEntity<Unit> {
        return ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    }
    ...
    fun bookGet(
        @Parameter(description = "書籍名を指定します。指定がない場合は登録されている書籍すべてを取得します。") @RequestParam(
            value = "bookName",
            required = false
        ) bookName: String?
