...
interface AuthorApi {
    ...
    fun authorAuthorIdPut(@Parameter(description = "著者IDを指定します", required = true) @PathVariable("authorId") authorId: kotlin.Int,@Parameter(description = "", required = true) @RequestBody authorNameRequest: AuthorNameRequest): ResponseEntity<Unit> {
        return ResponseEntity(HttpStatus.NOT_IMPLEMENTED)
    }
