...
import codetest.bookstore.api.generated.model.AuthorAndBookListInner
import codetest.bookstore.api.generated.model.AuthorNameRequest
import codetest.bookstore.api.generated.model.BookAndAuthorRequest
import codetest.bookstore.api.generated.model.BookAuthorSet
...
interface BookstoreApi {
    ...
    fun bookstoreBookIdPut(@Parameter(description = "変更対象の書籍IDを指定します", required = true) @PathVariable("bookId") bookId: kotlin.Int,@Parameter(description = "", required = true) @RequestBody authorNameRequest: AuthorNameRequest): ResponseEntity<BookAuthorSet> {
